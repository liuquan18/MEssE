...
def get_batch_callback():
    global net, optimizer, losses  # Declare as global to persist across callback invocations
    ...
    # Get cell coordinates (longitude, latitude) for potential interpolation
